...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__window_js__ = __webpack_require__(324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__main_css__ = __webpack_require__(318);
...
var Main = function (_Component) {
    ...
    function Main(root) {
        ...
        _this.grid.on('checkwin', _this.handleWin.bind(_this));
        ...
        _this.window = new __WEBPACK_IMPORTED_MODULE_4__window_js__["a" /* default */](root.querySelector('.window'));
        _this.window.on('click', _this.handleWindowClick.bind(_this));
        return _this;
    }
    ...
    _createClass(Main, [{
        ...
        key: 'handleWin',
        value: function handleWin(firer) {
            ...
            if (whowin != 2) {
                ...
                try {
                    for (var _iterator = firer.cells[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var Banner = function (_Component) {
    ...
    function Banner(root) {
        ...
        _this.rolex = new __WEBPACK_IMPORTED_MODULE_1__role_js__["a" /* default */](root.querySelector('.rolex'));
        _this.roleo = new __WEBPACK_IMPORTED_MODULE_1__role_js__["a" /* default */](root.querySelector('.roleo'));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_css__ = __webpack_require__(317);
...
var Cell = function (_Component) {
    ...
    function Cell(root) {
        ...
        _this.role = 2; //0 for O  1 for X 2 for nothing
    ...
    _createClass(Grid, [{
        ...
        value: function checkwin() {
            ...
            if (this.cells[0].role == this.cells[1].role && this.cells[1].role == this.cells[2].role) {
                if (this.cells[0].role == 0) return 0; //O win
                else if (this.cells[0].role == 1) return 1; //X win 
            }
            if (this.cells[3].role == this.cells[4].role && this.cells[4].role == this.cells[5].role) {
                if (this.cells[3].role == 0) return 0; //O win
                else if (this.cells[3].role == 1) return 1; //X win 
            }
            if (this.cells[6].role == this.cells[7].role && this.cells[7].role == this.cells[8].role) {
                if (this.cells[6].role == 0) return 0; //O win
                else if (this.cells[6].role == 1) return 1; //X win 
            }
            ...
            if (this.cells[1].role == this.cells[4].role && this.cells[4].role == this.cells[7].role) {
                if (this.cells[1].role == 0) return 0; //O win
                else if (this.cells[1].role == 1) return 1; //X win 
            }
            if (this.cells[2].role == this.cells[5].role && this.cells[5].role == this.cells[8].role) {
                if (this.cells[2].role == 0) return 0; //O win
                else if (this.cells[2].role == 1) return 1; //X win 
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reset_css__ = __webpack_require__(319);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_css__ = __webpack_require__(320);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__turn_css__ = __webpack_require__(323);
